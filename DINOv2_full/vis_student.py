...
def vis_augmented_teacher():
    ...
    parser.add_argument("--distilled_path", type=str, default="/data/chenyinjie/CYJcode/traindistill/DINOv2_full/distilledweights/distilled_dinov2_weights_70.pth")
    ...
    for i in range(args_dict['batch_size']):
        ...
        feature_map = student_img_feats[i].cpu().float().detach().numpy() # [num_patches, hidden_size]
        eps = 1e-8
    ...
    plt.savefig("distilled_DINOv2_FFN.png", dpi=300)  # Save as a single image
