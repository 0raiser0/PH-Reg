...
data_root = '/data/chenyinjie/CYJcode/data/ADE20k/ADEChallengeData2016'
...
model = dict(
    ...
    backbone=dict(
        ...
        distilled_weight="/data/chenyinjie/CYJcode/traindistill/DINOv2_full/distilledweights/distilled_dinov2_weights_30.pth",
        patch_size=14,
        freeze_weights=True,
