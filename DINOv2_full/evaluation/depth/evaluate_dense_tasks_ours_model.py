...
def main(args):
    ...
    # final dinov2
    from dvt.models.ours_dinov2_new import RegDINOv2Base
    pretrained = "/data/chenyinjie/CYJcode/distillation/DistillDINOv2/pretrained/facebook/dinov2-base"

    dino_model = RegDINOv2Base(pretrained_path=pretrained)
    dino_model.load_state_dict(torch.load(
    "/data/chenyinjie/CYJcode/traindistill/DINOv2_full/distilledweights/distilled_dinov2_weights_30.pth"), strict=False)
    vit = DVT.PretrainedViTWrapper(model_identifier="vit_base_patch14_dinov2.lvd142m", modified_model=dino_model, stride=14)
