...
MODEL_LIST = [
    ...
    # we add these model based on Denoising-ViT
    "naclip",
    "maskclip",
    "dinov2_naclip",
    "dinov2_maskclip",
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if modified_model == None:
            ...
            _, self.transformation = self.create_model(model_identifier, **kwargs)
            del _
            self.model = modified_model

    @property
    def n_output_dims(self) -> int:
        if self.model_identifier == "vit_base_patch14_dinov2.lvd142m":
            return 768
