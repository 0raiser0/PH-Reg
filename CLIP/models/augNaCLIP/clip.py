...
# def teacher_model_initialization(pretrained, gaussian_std, arch, patch_size=16 ,input_resolution=(448,448)):
#     clip_model, _ = load(
#         name=pretrained,
#         device=None,
#         jit=False
...
#     # clip_vit.set_params("vanilla", 'csa', 0.0)
...
#     clip_vit.positional_embedding.data = upsampling_pos_embedding(old_patch_pos_embed=old_patch_pos_embed, 
#                                                     patch_size=patch_size, input_resolution=input_resolution)
...
#         patch_pos_embed_2d,
#         size=(input_resolution[0] // patch_size, input_resolution[1] // patch_size),
#         mode='bicubic',
#         align_corners=False,
